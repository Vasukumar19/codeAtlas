...
class TeamOrchestrator:
    ...
    async def orchestrate(self, query: str, context: ContextPackage, model_name: str = "OpenAI") -> str:
        ...
        system_instruction = """You are the Lead Synthesizer for an AI Agent Team. 
